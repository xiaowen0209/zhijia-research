...
// ===== 场景实测数据 =====
const SCENARIO_DATA = [
  { name: "高速前方事故车", cat: "高速", desc: "模拟高速路段前方突发事故车辆，测试AEB响应和紧急变道能力" },
  { name: "高速施工锥桶", cat: "高速", desc: "模拟高速公路施工区域锥桶引导变道，测试施工场景识别和应对" },
  { name: "高速夜间反光", cat: "高速", desc: "夜间高速公路强反光条件，测试摄像头抗眩光和感知稳定性" },
  { name: "城市大转盘", cat: "城区", desc: "复杂环形交叉路口，测试路径规划和信号灯识别能力" },
  { name: "小学生横穿马路", cat: "城区", desc: "模拟儿童突然横穿，测试VRU识别和紧急制动响应速度" },
  { name: "路边违停绕行", cat: "城区", desc: "狭窄道路遇路边违停车辆，测试借道绕行决策和平滑度" },
  { name: "无保护左转", cat: "城区", desc: "无左转信号灯路口，测试对向车流间隙判断和左转时机" },
  { name: "窄路会车", cat: "城区", desc: "双向单车道窄路遇对向来车，测试宽度判断和让行策略" }
];

const SCENARIO_RESULTS = [
  { brand:"H", scores:{ "高速前方事故车":9.0,"高速施工锥桶":9.2,"高速夜间反光":9.0,"城市大转盘":8.8,"小学生横穿马路":9.0,"路边违停绕行":9.5,"无保护左转":9.3,"窄路会车":9.0 }},
  { brand:"X", scores:{ "高速前方事故车":8.8,"高速施工锥桶":8.5,"高速夜间反光":8.5,"城市大转盘":9.0,"小学生横穿马路":8.5,"路边违停绕行":9.0,"无保护左转":9.2,"窄路会车":8.8 }},
  { brand:"T", scores:{ "高速前方事故车":9.5,"高速施工锥桶":8.0,"高速夜间反光":9.2,"城市大转盘":7.5,"小学生横穿马路":9.0,"路边违停绕行":7.0,"无保护左转":8.0,"窄路会车":7.5 }},
  { brand:"L", scores:{ "高速前方事故车":8.5,"高速施工锥桶":8.2,"高速夜间反光":8.0,"城市大转盘":8.5,"小学生横穿马路":8.0,"路边违停绕行":8.5,"无保护左转":8.2,"窄路会车":8.3 }},
  { brand:"Mi",scores:{ "高速前方事故车":8.0,"高速施工锥桶":7.8,"高速夜间反光":7.5,"城市大转盘":8.0,"小学生横穿马路":7.5,"路边违停绕行":8.0,"无保护左转":7.8,"窄路会车":8.0 }},
  { brand:"HX",scores:{ "高速前方事故车":8.8,"高速施工锥桶":8.5,"高速夜间反光":8.0,"城市大转盘":8.5,"小学生横穿马路":8.5,"路边违停绕行":9.2,"无保护左转":8.8,"窄路会车":8.5 }},
  { brand:"BYD",scores:{ "高速前方事故车":8.2,"高速施工锥桶":7.5,"高速夜间反光":7.0,"城市大转盘":8.0,"小学生横穿马路":7.5,"路边违停绕行":8.0,"无保护左转":7.5,"窄路会车":8.0 }}
];
